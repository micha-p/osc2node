...
*/
function bm_whats_new() // CLASS
{
    this.code = 'bm_whats_new';
    this.group = 'boxes';
    this.title;
    this.description;
    this.sort_order;
    ...
    this.check = function()
    {
        return typeof 'MODULE_BOXES_WHATS_NEW_STATUS' != 'undefined'
    }
    ...
    this.execute = function(oscTemplate)
    {
        ...
        if (random_product = tep_random_select('select products_id, products_image, products_tax_class_id, products_price from ' 
                                              + TABLE_PRODUCTS 
                                              + ' where products_status = \'1\' order by products_date_added desc limit ' 
    ...
    this.install = function()
    {
        tep_db_query('insert into ' 
        			...
        			+ "values (\'Enable What\\\'s New Module\', \'MODULE_BOXES_WHATS_NEW_STATUS\', \'True\', \'Do you want to add the module to your shop?\', \'6\', \'1\', \'tep_cfg_select_option(array(\\\'True\\\', \\\'False\\\'), \', now())")
        tep_db_query('insert into ' 
        			+ TABLE_CONFIGURATION 
        			+ ' (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) '
        			+ " values (\'Content Placement\', \'MODULE_BOXES_WHATS_NEW_CONTENT_PLACEMENT\', \'Left Column\', \'Should the module be loaded in the left or right column?\', \'6\', \'1\', \'tep_cfg_select_option(array(\\\'Left Column\\\', \\\'Right Column\\\'), \', now())")
        tep_db_query('insert into ' 
        			+ TABLE_CONFIGURATION 
        			+ ' (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) '
        			+ "values (\'Sort Order\', \'MODULE_BOXES_WHATS_NEW_SORT_ORDER\', \'0\', \'Sort order of display. Lowest is displayed first.\', \'6\', \'0\', now())")
    }
