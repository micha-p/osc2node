...
// http://nodejsdb.org/docs/		   C++ extension
...
function tep_db_error(query, errno)
{
   ...
   print('<font color="#000000"><strong>' + errno + ' - ' + '<br /><br />' + query + '<br /><br /><small><font color="#ff0000">[TEP STOP]</font></small><br /><br /></strong></font>');
}

function tep_db_query(queryString, callback)
{
    // console.log('start')
    var r = connection.query(queryString, function(err, rows, fields) {
...
var a = tep_db_query(queryString,cycle)
tep_db_close()
