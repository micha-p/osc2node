...
function tep_db_connect(){return connection.connectSync(DB_SERVER,DB_SERVER_USERNAME,DB_SERVER_PASSWORD,DB_DATABASE)}
function tep_db_close(){return connection.closeSync()}
function tep_db_query(queryString){return connection.querySync(queryString)}
...
print(tep_db_insert_id(a))
print(tep_db_affected_rows(a))
print(tep_db_get_server_info())
tep_db_close()
